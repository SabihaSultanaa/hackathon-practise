...
export default function ShoppingCart() {
  ...
  return (
    <div className="mx-auto max-w-[1170px] space-y-10 p-6 mt-[50px]">
      <Table>
        <TableHeader>
          <TableRow className="  border-2 border-gray-100  h-[60px] mb-[500px]">
        ...
        <TableBody>
          {cartItems.map((item) => (
            <TableRow key={item.id} className="border-gray-100 border-2" >
              ...
              <TableCell>
                <div className="flex w-[72px] items-center justify-between rounded  px-3 py-2">
