  ...
  return (
    <>
      {loop.map((item, index)=>{return (
              ...
              {/* Top Image */}
              <div className="relative w-full h-[250px] bg-[#F5F5F5] p-2 flex justify-center items-center">
                <Image src={item.src} alt="image" width={182} height={162}></Image>
              ...
              <div className="w-full flex flex-col gap-[6px] text-[16px] leading-[24px] font-medium pl-[3px]">
                ...
                <div className="flex gap-1 items-center">
                  {[...Array(item.star)].map(() => {
                    return <Star size={18} fill="#FFAD33" color="#FFAD33" />;
                  })}
