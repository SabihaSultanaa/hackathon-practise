...
export default function Footer() {
  return (
    <footer className="bg-black text-white pt-[80px] pb-[0px]">
      <div className="container mx-auto px-[120px] ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-[0px] mb-[5px]">
          
          {/* Exclusive Section */}
          <div className="space-y-8 ">
            <h2 className="text-[24px] leading-[24px] font-bold tracking-[1px]">Exclusive</h2>
            <h3 className="text-[20px] leading-[28px] font-medium tracking-[1px]">Subscribe</h3>
            <p className="text-base  w-[240px]">Get 10% off your first order</p>
            <div className="relative flex items-center space-x-2">
              <Input 
                type="email" 
                placeholder="Enter your email" 
                className="bg-transparent border-white/40 w-[370px] border-[2px] border-white py-[20px] text-[30px]"
              />

                <StepForward className='absolute left-[140px] top-2' size={30}/> 
            </div>
          </div>

          {/* Support Section */}
          <div className="space-y-8 ml-[45px] w-[200px] ">
          ...
          {/* Quick Link Section */}
          <div className="space-y-8 ml-[20px]">
        ...
        {/* Social Media Icons */}
        <div className="flex justify-center space-x-6 mb-8 relative left-[420px] bottom-[10px]">
        ...
        {/* Copyright */}
        <div className="text-center text-white/60  border-t border-white/40 h-[40px] w-full">
          <p className="pt-[5px] ">&copy; Copyright Rimel 2022. All right reserved</p>
        </div>
      </div>
    </footer>
  )
